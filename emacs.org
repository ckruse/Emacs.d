...
#+begin_src emacs-lisp
  (use-package smart-mode-line
    ...
    :config (progn
              (custom-set-variables
               '(sml/hidden-modes (quote (" hl-p" " ivy" " RuboCop" " ck/keys" " pair" " HRB" " AC" " GitGutter" " FlyC" " FlyC-" " MMM" " Rails" " yas" " SP" " WS" " MRev" " ARev" " company"))))
...
#+begin_src emacs-lisp
  (define-key ck/keys-minor-mode-map "\C-ccl"
    (defhydra launchers (:color blue)
      ...
      ("." ck-put-file-name-on-clipboard "copy filename to clipboard")))
#+end_src
