...
#+begin_src emacs-lisp
  (setq ck-machine-filename (concat system-name ".el"))
    ...
    (use-package circe
      ...
      :config (progn
                ...
                (setq circe-reduce-lurker-spam t
                      ...
                      lui-flyspell-p t
                      lui-flyspell-alist '(("#selfhtml" "deutsch")
                                           ("#warpzone" "deutsch")
                                           (".*" "american")))
...
Nice little minor mode to remember me of better ways how to do things.

#+begin_src emacs-lisp
  (use-package schrute
    :init (progn
            (setf schrute-shortcuts-commands '((avy-goto-line   . (next-line))
                                               (avy-goto-line . (previous-line))
                                               (avy-goto-line . (forward-paragraph))
                                               (avy-goto-line . (backward-paragraph))
                                               (avy-goto-word-1 . (left-char))
                                               (avy-goto-word-1 . (right-char))
                                               (avy-goto-word-1 . (left-word))
                                               (avy-goto-word-1 . (right-word))))
            (schrute-mode)))
#+end_src
