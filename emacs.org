...
#+begin_src emacs-lisp
  (define-key my-keys-minor-mode-map "\C-ccf"
    (defhydra often-used-files (:color blue)
      "often used files"
                  ("p" (lambda () (interactive) (find-file "~/Documents/org/passwords.org.gpg")) "open passwords file")
                  ("i" (lambda () (interactive) (find-file "~/Documents/org/inbox.org")) "Open org-mode inbox file")
                  ("t" (lambda () (interactive) (find-file "~/Documents/org/work/termitel.org")) "Open termitel org-mode file")))
...
#+begin_src emacs-lisp
  ...
  (global-set-key "\C-cctp" 'run-test-at-point)
  (global-set-key "\C-cctf" 'run-test-file)
  (global-set-key "\C-ccts" 'run-test-suite)
#+end_src
