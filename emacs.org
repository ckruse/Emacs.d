...
** Initialisation
   ...
   Inspired by [[Sacha Chua's Emacs configuration]], I'm using a
...
(define-key ctl-x-map "o" 'often-used-files-map)

(define-key often-used-files-map "p" (lambda () (interactive) (find-file "~/Documents/org/passwords.org.gpg")))
(define-key often-used-files-map "p" (lambda () (interactive) (find-file "~/Documents/org/inbox.org")))
#+end_src
