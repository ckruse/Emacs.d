...
#+begin_src emacs-lisp
  (custom-set-variables
   ...
   '(custom-safe-themes    (quote ("1c57936ffb459ad3de4f2abbc39ef29bfb109eade28405fa72734df1bc252c13"
...
#+begin_src emacs-lisp
  (define-key my-keys-minor-mode-map "\C-ccf"
    (defhydra often-used-files (:color blue)
      ...
      ("p" (org-passwords) "open passwords file")
...
#+begin_src emacs-lisp
  (use-package avy
    ...
    :init (progn
            (define-key my-keys-minor-mode-map (kbd "C-c SPC") 'avy-goto-word-1)
            (define-key my-keys-minor-mode-map (kbd "M-g g") 'avy-goto-line)
            (define-key my-keys-minor-mode-map (kbd "M-g M-g") 'avy-goto-line)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-capture-templates
        (quote (("t" "todo" entry (file+headline "~/Documents/org/inbox.org" "Inbox")
                ...
                ("p" "password" entry (file "~/Documents/org/passwords-new.gpg")
  ...
  (setq org-passwords-file "~/Documents/org/passwords-new.gpg")

  (eval-after-load "org-passwords"
    '(progn
       (define-key org-passwords-mode-map (kbd "C-c u")
         'org-passwords-copy-username)
       (define-key org-passwords-mode-map (kbd "C-c p")
         'org-passwords-copy-password)
       (define-key org-passwords-mode-map (kbd "C-c o")
...
#+begin_src emacs-lisp
  (use-package expand-region
    ...
    :init (progn
            (define-key my-keys-minor-mode-map "\C-cce"
...
#+begin_src emacs-lisp
  (use-package ruby-mode
    ...
    :init (progn
            ...
            (define-key my-keys-minor-mode-map "\C-ccr"
