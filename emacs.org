...
#+begin_src emacs-lisp
  (use-package whitespace
    ...
    :init
    (setq whitespace-global-modes '(c-mode c++-mode ruby-mode web-mode php-mode js2-mode css-mode scss-mode elixir-mode conf-space-mode shell-script-mode))
